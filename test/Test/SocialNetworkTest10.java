...
/**
 * Unit tests class
 * for SocialNetwork class
 *
 * @author 1050441
 * 
 */
public class SocialNetworkTest10 {
    ...
    public void LoadData() throws IOException
    {
        try
        {
            ...
            socialNetwork.ReadCitiesFromFile("Data/files10/cities10.txt");
             //Read Users from file
            socialNetwork.ReadUsersFromFile("Data/files10/users10.txt");
